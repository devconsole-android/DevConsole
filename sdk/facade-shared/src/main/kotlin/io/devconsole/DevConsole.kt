...
object DevConsole {
     ...
     * and [io.devconsole.api.BrowserBinding]. The default `StartRequest()` binds LAN; pass
     * `bindingMode = BindingMode.LOOPBACK` explicitly for the safer ADB-only choice on an untrusted
     * network. See `docs/THREAT_MODEL.md` at the repository root.
     *
     * @param request binding mode and port range for this start attempt. Defaults to LAN on
     *   `8080..8099`.
